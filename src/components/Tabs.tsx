...
import { NativeBaseProvider, Box, Text, Center, useColorMode, useTheme } from 'native-base';
    ...
    return (
      ...
      >
        {props.navigationState.routes.map((route, i) => {
          ...
          const borderColor = index === i ? 'rgb(2, 120, 171)' : 'rgb(64, 64, 64)';
          return (
            <Box borderBottomWidth={borderWidth} borderColor={borderColor} alignItems="center" p="3">
